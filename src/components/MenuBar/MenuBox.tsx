...
export default function MenuBox({title,icon}:dataType) {
  return (
    <div >
      <div dir='rtl' className="w-[358px] flex items-center h-[103px] bg-white rounded-[33px] px-2">
        <div className="flex items-center">
            ...
            <div className="icon mx-6  text-[#03045E] flex items-center justify-center text-[70px] ">{icon}</div>
